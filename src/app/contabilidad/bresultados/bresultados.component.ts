...
@Component({
  selector: 'app-bresultados',
  templateUrl: './bresultados.component.html',
  styleUrl: './bresultados.component.scss'
})
  ...
  showComprobante(cuenta:any,modal:any){
    this.subcuenta = cuenta;
		this.modalRef = this.modalService.show(modal, {
			class: 'custom-window-class modal-dialog-centered modal-lg ',			
		});
